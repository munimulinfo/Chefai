...
const Contact = () => {
    ...
    <div className="container px-6 py-12 mx-auto">
        <div className='text-center'>
            <p className="font-medium text-red-500 dark:text-red-400 font-bold">Contact us</p>

            <h1 className="mt-2 text-3xl font-semibold text-gray-800 md:text-3xl dark:text-white">Get in touch</h1>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div>
                ...
                <p className="mt-2 text-green-500 dark:text-red-400">hello@chefai.com</p>
            </div>

            <div>
                <span className="inline-block p-3 text-red-500 rounded-full bg-red-100/80 dark:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" className="w-6 h-6">
                ...
                <p className="mt-2 text-green-500 dark:text-red-400">100 Smith Street Collingwood VIC 3066 AU</p>
            </div>
            ...
            <div>
                ...
                <p className="mt-2 text-green-500 dark:text-green-400">+1 (555) 000-0000</p>
            </div>
        </div>
    </div>
</section>
